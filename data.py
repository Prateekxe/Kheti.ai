...
class_details = {
    "Cashew Anthracnose": {
        ...
        "Cure": [
            "Fungicide Application: At the first sign of anthracnose, apply copper-based fungicides or other recommended fungicides, following the manufacturer’s instructions. Multiple applications may be needed during the growing season.",
